...
public class USSS5 {
    ...
    public void monitorStart(SensorMonitor sensorMonitor) throws InterruptedException {
        ...
        System.out.println("Sensor 5 - Waiting for the sensor1 to be ready (2s)...");
        Thread.sleep(2_000L);
        ...
        while (go) {
            ...
            try {
                synchronized (mainThread) {
                    ...
                    if (DEBUG) System.out.println("Sensor 5 - MainThread done waiting (" + diff + " ms)");
            ...
            if (ok) {
                ...
                if (end > 0 && start > 0) {
                    ...
                    if (distance > MIN_DIST && distance < MAX_DIST
                        ...
                        if (sensorMonitor.isActiveSensor5() && rs5.getState()) {
